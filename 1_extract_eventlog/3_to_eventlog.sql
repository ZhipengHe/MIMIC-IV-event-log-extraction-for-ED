...
-- edstay 
SELECT fc.stay_id, st.subject_id, fc.hadm_id, st.timestamps, st.activity,
...
UNION ALL
-- triage 
SELECT fc.stay_id, tr.subject_id, fc.hadm_id, tr.timestamps, tr.activity,
...
UNION ALL 
-- vitalsign 
SELECT fc.stay_id, vt.subject_id, fc.hadm_id, vt.timestamps, vt.activity, 
    NULL AS seq_num, NULL AS icd_code, NULL AS icd_version, NULL AS icd_title,
...
UNION ALL
-- medrecon
SELECT fc.stay_id, med.subject_id, fc.hadm_id, med.timestamps, med.activity, 
	NULL AS seq_num, NULL AS icd_code, NULL AS icd_version, NULL AS icd_title,
	NULL AS temperature, NULL AS heartrate, NULL AS resprate, NULL AS o2sat, NULL AS sbp, NULL AS dbp, NULL AS pain, NULL AS acuity, NULL AS chiefcomplaint,
    NULL AS rhythm,
...
UNION ALL
-- pyxis
SELECT fc.stay_id, py.subject_id, fc.hadm_id, py.timestamps, py.activity, 
	NULL AS seq_num, NULL AS icd_code, NULL AS icd_version, NULL AS icd_title,
	NULL AS temperature, NULL AS heartrate, NULL AS resprate, NULL AS o2sat, NULL AS sbp, NULL AS dbp, NULL AS pain, NULL AS acuity, NULL AS chiefcomplaint,
    NULL AS rhythm,
...
-- COPY "mimic_insights"."ed_tables" TO PROGRAM 'gzip > your_file_path_here.csv' DELIMITER ',' CSV HEADER;
